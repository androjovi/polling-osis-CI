  ...
  <div class="col-md-6">
            ...
            <div class="box box-primary" style="display:none;" id="input_ketua1">
              <div class="box-header with-border">
                <h3 class="box-title">Calon ketua osis nomor urut 1</h3>
              </div>
              <!-- /.box-header -->
              <!-- form start -->
              <form role="form">
            ...
            <div class="col-md-6">
                      ...
                      <div class="box box-primary" style="display:none;" id="input_ketua2">
                        <div class="box-header with-border">
                          <h3 class="box-title">Calon ketua osis nomor urut 2</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form">
                    ...
                    <div class="col-md-6">
                              ...
                              <div class="box box-primary" style="display:none;" id="input_ketua3">
                                <div class="box-header with-border">
                                  <h3 class="box-title">Calon ketua osis nomor urut 3</h3>
                                </div>
                                <!-- /.box-header -->
                                <!-- form start -->
                                <form role="form">
                                ...
                                <div class="col-md-6">
                                          ...
                                          <div class="box box-primary" style="display:none;" id="input_wakil1">
                                            <div class="box-header with-border">
                                              <h3 class="box-title">Calon wakil osis nomor urut 1</h3>
                                            </div>
                                            <!-- /.box-header -->
                                            <!-- form start -->
                                            <form role="form">
                                          ...
                                          <div class="col-md-6">
                                                    ...
                                                    <div class="box box-primary" style="display:none;" id="input_wakil2">
                                                      <div class="box-header with-border">
                                                        <h3 class="box-title">Calon wakil osis nomor urut 2</h3>
                                                      </div>
                                                      <!-- /.box-header -->
                                                      <!-- form start -->
                                                      <form role="form">
                                                    ...
                                                    <div class="col-md-6">
                                                              ...
                                                              <div class="box box-primary" style="display:none;" id="input_wakil3">
                                                                <div class="box-header with-border">
                                                                  <h3 class="box-title">Calon wakil osis nomor urut 3</h3>
                                                                </div>
                                                                <!-- /.box-header -->
                                                                <!-- form start -->
                                                                <form role="form">
